---
name: example-style
description: EXAMPLE (delete me) — how a personal writing-style skill looks once a retro ships one. Loads when drafting short messages on the user's behalf.
---

# example-style — a deletable example
